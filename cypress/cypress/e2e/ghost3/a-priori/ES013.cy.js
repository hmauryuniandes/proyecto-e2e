...
describe('Testing General settings', () => {
  let _siteObject = new Site('ES013');
  let _loginObject = new Login('ES013');
  let _staffObject = new Staff('ES013');
  let _menuObject = new Menu('ES013');
  ...
  it("Test Slug a priori mockaroo", () => {
    ...
    _staffObject.when_user_type_new_slug();
