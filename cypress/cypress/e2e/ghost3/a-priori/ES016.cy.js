...
describe('Testing General settings', () => {
  let _siteObject = new Site('ES016');
  let _loginObject = new Login('ES016');
  let _staffObject = new Staff('ES016');
  let _menuObject = new Menu('ES016');
  ...
  afterEach(() => {
    _staffObject.when_user_type_old_facebook();
    _staffObject.when_user_save_settings();
  })

  it("Test Facebook faker", () => {
    ...
    _staffObject.when_user_type_new_facebook_faker();
