...
describe("Testing page creation", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES120");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES120");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES120");
  ...
  it("Test edit page", ()=>{
     ...
     _pageObject = new Page("ES120");
     _pageObject.when_bad_edit_the_publication_time_of_a_page_random();
