...
describe("Testing page creation", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES116");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES116");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES116");
  ...
  it("Test edit page", ()=>{
     ...
     _pageObject = new Page("ES116");
     _pageObject.when_edit_the_publication_date_of_a_page_random();
