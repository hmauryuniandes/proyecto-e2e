...
describe("Testing page edition", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES094");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES094");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES094");
  ...
  it("Test edit page", ()=>{
     ...
     _pageObject = new Page("ES094");
     _pageObject.when_user_click_on_edit_page_random();
