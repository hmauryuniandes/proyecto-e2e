...
describe('Testing General settings', () => {
  let _siteObject = new Site('ES018');
  let _loginObject = new Login('ES018');
  let _staffObject = new Staff('ES018');
  let _menuObject = new Menu('ES018');
  ...
  it("Test Slug faker", () => {
    ...
    _staffObject.when_user_type_new_twitter_faker();
