...
describe('Testing General Social Account fan page facebook', () => {
  let _siteObject = new Site('ES022');
  let _loginObject = new Login('ES022');
  let _generalObject = new General('ES022');
  let _menuObject = new Menu('ES022');
  ...
  it("Test Title & description", () => {
    ...
    _generalObject.when_user_type_fan_page_facebook_faker();
