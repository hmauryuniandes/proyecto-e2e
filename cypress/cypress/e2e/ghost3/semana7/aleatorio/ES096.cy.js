...
describe("Testion new menus", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES096");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES096");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES096");
    menuObject.when_user_navigate_to_pages();

    _pageObject = new Page("ES096");
  ...
  it("Create new page menu en la navegacion principal", () => {
    menuObject = new Menu("ES096");
    _pageObject = new Page("ES096");
    _configObject = new Config("ES096");

    menuObject.when_user_navigate_to_config();
    _configObject.when_user_create_new_menu_on_primary_navigation_random();
