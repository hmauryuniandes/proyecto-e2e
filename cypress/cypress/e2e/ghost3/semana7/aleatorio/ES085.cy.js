...
describe("Testing post creation", () => {
  let _siteObject = new Site('ES085');
  let _loginObject = new Login('ES085');
  let _postObject = new Post('ES085');
  let menuObject = new Menu('ES085');
  ...
  it("Test create new post", () => {
    ...
    _postObject.when_user_edit_metadata_aleatorio();
