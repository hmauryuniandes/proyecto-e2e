...
describe('Testing General settings', () => {
  let _siteObject = new Site('ES030');
  let _loginObject = new Login('ES030');
  let _staffObject = new Staff('ES030');
  let _menuObject = new Menu('ES030');
  ...
  afterEach(() => {
    _staffObject.when_user_type_old_location();
    _staffObject.when_user_save_settings();
  })

  it("Test location a priori mockaroo", () => {
    ...
    _staffObject.when_user_type_new_location_faker();
