...
describe("Testing post creation", () => {
  let _siteObject = new Site('ES078');
  let _loginObject = new Login('ES078');
  let _postObject = new Post('ES078');
  let menuObject = new Menu('ES078');
  ...
  it("Test create new post", () => {
    ...
    _postObject.when_user_add_bookmark();
