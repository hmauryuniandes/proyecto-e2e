...
describe("Testion new menus", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES111");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES111");
    _loginObject.when_user_enter_credentials_and_click_on_login();
  });

  it("Create new page menu en la navegacion principal", () => {
    menuObject = new Menu("ES111");
    _pageObject = new Page("ES111");
    _configObject = new Config("ES111");

    menuObject.when_user_navigate_to_config();
    _configObject.when_user_create_new_menu_on_primary_navigation_empty_title();
    _configObject.then_the_menu_was_not_created();
  });
