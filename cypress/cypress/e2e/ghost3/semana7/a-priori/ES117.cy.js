...
describe("Testing page creation", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES117");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES117");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES117");
  ...
  it("Test edit page", ()=>{
     ...
     _pageObject = new Page("ES117");
     _pageObject.when_edit_the_publication_time_of_a_page_a_priory();
