...
describe("Testion new menus", () => {
  ...
  beforeEach(()=>{
    ...
    _siteObject = new Site("ES097");
    _siteObject.given_user_visit_ghost();

    _loginObject = new Login("ES097");
    _loginObject.when_user_enter_credentials_and_click_on_login();

    menuObject = new Menu("ES097");
    menuObject.when_user_navigate_to_pages();

    _pageObject = new Page("ES097");
  ...
  it("Create new page menu en la navegacion secundaria", () => {
    menuObject = new Menu("ES097");
    _pageObject = new Page("ES097");
    _configObject = new Config("ES097");
    
    menuObject.when_user_navigate_to_config();
    _configObject.when_user_create_new_menu_onsecondary_navigation_a_priory();
