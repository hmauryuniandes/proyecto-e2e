...
describe('Testing General settings', () => {
  let _siteObject = new Site('ES029');
  let _loginObject = new Login('ES029');
  let _staffObject = new Staff('ES029');
  let _menuObject = new Menu('ES029');
  ...
  it("Test location a priori mockaroo", () => {
    ...
    _staffObject.when_user_type_new_location();
