...
describe("Testing post creation", () => {
  let _siteObject = new Site('ES065');
  let _loginObject = new Login('ES065');
  let _postObject = new Post('ES065');
  let menuObject = new Menu('ES065');
  ...
  it("Test create new post", () => {
    ...
    _postObject.when_user_edit_metadata_a_priori();
